...
**Phase 72 — Planned.** Sovereign Policy Engine — a declarative guard layer that evaluates proposed OS actions against an ordered set of allow/deny policies before they execute, returning the matching rule and verdict; stdlib only; thread-safe via `threading.Lock`.
